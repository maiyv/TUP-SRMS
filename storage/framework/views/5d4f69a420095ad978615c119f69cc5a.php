...
<head>
    ...
    <link href="<?php echo e(asset('css/student-request.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <div class="student-content">
        ...
        <!-- Form -->
         <div class="container">
            <form action="<?php echo e(route('student.service.request.submit')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
            ...
            <div class="modal fade show" id="serviceRequestSuccessModal" tabindex="-1" role="dialog" style="display: block; background-color: rgba(0,0,0,0.5);">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Your service request for <strong><?php echo e(session('serviceCategory')); ?></strong> has been submitted successfully.</p>
                            <p>Request ID: <strong><?php echo e(session('requestId')); ?></strong></p>
                        </div>
                        <div class="modal-footer">
...
<?php /**PATH C:\xampp\htdocs\SRMS\resources\views/users/student-request.blade.php ENDPATH**/ ?>