...
<div class="modal fade" id="confirmRemoveImageModal" tabindex="-1" role="dialog" aria-labelledby="confirmRemoveImageModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?php echo e(route('removeProfileImage')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\SRMS\resources\views/users/modals/profile-modal.blade.php ENDPATH**/ ?>