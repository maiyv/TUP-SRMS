...
<head>
    ...
    <link href="<?php echo e(asset('css/admin_servicerequest.css')); ?>" rel="stylesheet">
                ...
                <table class="request-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><input type="checkbox" name="selected_requests[]" value="<?php echo e($request['id']); ?>"></td>
                                <td><?php echo e($request['id']); ?></td>
                                <td><?php echo $request['request_data']; ?></td>
                                <td><?php echo e($request['role']); ?></td>
                                <td>
                                    <strong>Date: </strong><span><?php echo e($request['date']->format('Y-m-d')); ?></span><br>
                                    <strong>Time: </strong><span><?php echo e($request['date']->format('g:i A')); ?></span>
                                </td>
                                <td>
                                    <span class="badge 
                                ...
                                <td class="btns">
                                    <?php if($request['status'] == 'Pending'): ?>
                                        <button type="button" class="btn-approve" data-id="<?php echo e($request['id']); ?>" data-type="<?php echo e($request['type']); ?>" data-details="<?php echo e($request['request_data']); ?>">
                                            Approve
                                        </button>
                                        <button type="button" class="btn-reject" data-id="<?php echo e($request['id']); ?>" data-type="<?php echo e($request['type']); ?>" data-details="<?php echo e($request['request_data']); ?>">
                                            Reject
                                        </button>
                                    <?php endif; ?>
                                </td>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchAvailableUITCStaff() {
                return $.ajax({
                    url: '<?php echo e(route("get.available.technicians")); ?>',
                    method: 'GET',
            ...
            $('#saveAssignStaffBtn').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("admin.assign.uitc.staff")); ?>',
                    method: 'POST',
                    data: formData,
            ...
            $('#confirmRejectBtn').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("admin.reject.service.request")); ?>',
                    method: 'POST',
                    data: formData,
                    success: function(response) {
                        if (response.success) {
            ...
            $('#delete-btn').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(route("admin.delete.service.requests")); ?>',
                            method: 'POST',
                            data: {
...
</html><?php /**PATH C:\xampp\htdocs\SRMS\resources\views/admin/service-request.blade.php ENDPATH**/ ?>