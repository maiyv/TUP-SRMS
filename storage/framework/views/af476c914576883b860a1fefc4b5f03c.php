...
<head>
    ...
    <link href="<?php echo e(asset('css/facultyservice.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <div class="faculty-content">
        ...
        <div class="container">
            ...
            <form id="facultyServiceForm" method="POST" action="<?php echo e(route('faculty.service-request.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
            ...
            <div class="modal" id="serviceRequestSuccessModal" tabindex="-1" role="dialog" aria-labelledby="successModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Your service request for <strong><?php echo e(session('serviceCategory')); ?></strong> has been submitted successfully!
                            <br>
                            Request ID: <strong><?php echo e(session('requestId')); ?></strong>
                        </div>
    ...
    <script src="<?php echo e(asset('js/faculty-service.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\SRMS\resources\views/users/faculty-service.blade.php ENDPATH**/ ?>